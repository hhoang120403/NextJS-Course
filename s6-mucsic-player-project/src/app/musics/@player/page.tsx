  ...
  return (
    <div className='fixed bottom-0 left-[35%] w-[40rem] bg-[#171717] p-4 flex items-center justify-between text-white'>
      ...
      <div className='flex items-center gap-6'>
        ...
        <Pause className='cursor-pointer text-white hover:text-gray-300 transition-colors hidden' />

        <SkipForward className='cursor-pointer text-white hover:text-gray-300 transition-colors' />
      </div>
