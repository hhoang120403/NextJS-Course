          ...
          <ul className='space-y-4'>
            <li className='flex items-center justify-between bg-white rounded-lg shadow-md p-4'>
              <div>
                ...
                <p className='text-sm text-gray-600'>
                  New user registered on 2025-02-20
                </p>
              </div>
              <div>
                <p className='text-sm text-gray-500'>+12403 Users</p>
              </div>
            </li>
            ...
            <li className='flex items-center justify-between bg-white rounded-lg shadow-md p-4'>
              <div>
                ...
                <p className='text-sm text-gray-600'>
                  Sales grew up by 12% on 2025-02-20
                </p>
              </div>
              <div>
            ...
            <li className='flex items-center justify-between bg-white rounded-lg shadow-md p-4'>
              <div>
                ...
                <p className='text-sm text-gray-600'>
                  Traffic increased by 20% on 2025-02-20
                </p>
              </div>
              <div>
